...
public class SpecializationItemProvider 
	...
	/**
	 * This adds a property descriptor for the Spec Name feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addSpecNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Specialization_specName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Specialization_specName_feature", "_UI_Specialization_type"),
				 StudyplanPackage.Literals.SPECIALIZATION__SPEC_NAME,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Specialization)object).getSpecName();
